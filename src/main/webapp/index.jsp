<%@ page session="false" %>
<%@page import="com.nttdata.servlet.PageCounter" contentType="text/html" pageEncoding="UTF-8"%>
...
<%
  ...
  response.setHeader("Expires","Thu,01Dec299416:00:00GMT");
...
<p> Count increase everytime when you refresh <br>
<b style="color:red;">
